...
def regular_expression(regex, string):
    pattern = re.compile(regex)
    if pattern.match(string).group() == string:
        return True
    else:
        return False

print(regular_expression('ra.', 'ray'))
print(regular_expression('ra.', 'raymond'))
print(regular_expression('.*at', 'chat'))
print(regular_expression('.*at', 'chats'))